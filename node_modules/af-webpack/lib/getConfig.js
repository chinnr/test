...
function getConfig(opts = {}) {
  ...
  const config = {
    ...
    resolve: {
      ...
      plugins: process.env.TS_CONFIG_PATHS_PLUGIN !== 'none' ? [new TsConfigPathsPlugin()] : []
    },
    module: {
    ...
    new _systemBellWebpackPlugin.default(), ...(process.env.HARD_SOURCE === 'none' ? [] : [new _hardSourceWebpackPlugin.default()])].concat(opts.devtool ? [] : [new _webpack.default.SourceMapDevToolPlugin({
      columns: false,
